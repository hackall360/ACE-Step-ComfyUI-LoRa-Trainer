...
#
# This file is a verbatim copy of the official ACE‑Step training
# script.  It is included here so that the LoRA trainer node can
# execute without requiring the user to clone the original ACE‑Step
# repository.  The script defines a PyTorch Lightning module that
# implements the training loop for LoRA fine‑tuning.  For details on
# the training algorithm and available hyper‑parameters, consult the
...
class Pipeline(LightningModule):
    ...
    def infer_mert_ssl(self, target_wavs, wav_lengths):
        ...
        total_length = target_wavs.shape[1]
